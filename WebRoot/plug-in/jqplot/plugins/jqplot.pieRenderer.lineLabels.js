    ...
    $.jqplot.PieRenderer.prototype.draw = function (ctx, gd, options) {
        ...
        for (var i=0; i<gd.length; i++) {
            ...
            if (typeof(this.lineLabels !== 'undefined') && this.lineLabels) {
                ...
                if(next_end_y != 0 && line1_end_x * next_end_x > 0 ){
                	if(line1_end_y - next_end_y < 17 && line1_end_y - next_end_y > 0){
                	
                		line1_end_y = line1_end_y + 17 - (line1_end_y - next_end_y);
                	}
                	if(0 > line1_end_y - next_end_y > -17){
                	
                	}
                	if(next_end_x > 0 && line1_end_x > 0 && next_end_y > line1_end_y){
                		line1_end_y = next_end_y + 17;
                	}
                	
                }
                
                next_end_x = line1_end_x;
                next_end_y = line1_end_y;
                ...
                var l_x = line2_end_x + origin.x + l_x_offset-78;
