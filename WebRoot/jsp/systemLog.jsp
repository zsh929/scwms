		...
		<div >
			<div class="w936" > 
			    <div id="tb_" class="tb_"> 
		            <ul id="nav"> 
		            	<li style="text-align: left;font-size: 14px;font-weight: bold;padding-top: 3px">系统日志</li> 
				...
				<table cellpadding="0" cellspacing="0" border="0" class="stockItems">
					...
					<thead>
						<tr>
							...
							<th>操作内容</th>
							<th width="150px">sessionId</th>
						</tr>
					</thead>
				
					<c:forEach items="${requestScope['systemLog.list']}" var="systemLog" varStatus="status"  begin="0">
						...
						<tr>	
							...
							<td align="center">
								<c:out value="${systemLog.userName}" />
							</td>	
							<td align="center">
								
								<c:out value="${systemLog.type}" />
								
							</td>	
							<td align="center">
								
								<c:out value="${systemLog.loginAddress}" />
								
							</td>
							<td align="center">
								<fmt:formatDate value="${systemLog.operationTime}" pattern="yyyy-MM-dd HH:mm:ss"/>
								
							</td>
							<td align="center">
								<c:out value="${systemLog.operationContent}" />
							</td>
							
							<td align="center">
							 	<c:out value="${systemLog.sessionId}" />
							</td>
						</tr>
