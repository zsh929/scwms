...
<html> 
	...
	<body>
		...
		<html:form styleId="chargeEdit" action="/chargeDetail.do?method=payment">
		<div id="form_stylized" class="myform" >
			
			<label>收费金额</label><html:text property="paymentAmount" style="width:120px;text-align:right"/><br/>
			<label>收费日期</label><html:text property="paymentDate" styleClass="Wdate"  onclick="WdatePicker()" style="width:120px"/>
